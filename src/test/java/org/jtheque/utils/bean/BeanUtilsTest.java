...
public class BeanUtilsTest {
    ...
    public void testGetPropertyQuickly() {
        ...
        Object property1 = BeanUtils.getPropertyQuickly(instance, "property1");
        ...
        property1 = BeanUtils.getPropertyQuickly(instance, "property1");
    ...
    public void testCreateMemento() {
        ...
        TestClass memento = BeanUtils.createMemento(instance1, TestClass.class);
    ...
    public void testRestoreMemento() {
        ...
        BeanUtils.restoreMemento(instance1, memento);
    ...
    public void testToString() {
        ...
        assertEquals("TestClass{property1=0, property2=0, property3=null}", BeanUtils.toString(instance));

        instance.setProperty1(3);
        instance.setProperty2(44);
        instance.setProperty3("test");

        assertEquals("TestClass{property1=3, property2=44, property3=test}", BeanUtils.toString(instance));
    }
